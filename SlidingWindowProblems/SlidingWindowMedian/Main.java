...
/**
 * <a href="https://cses.fi/problemset/task/1076/"><h1>Sliding Window Median</h1><br/></a>
 * Given an array of {@code n} integers. Task is to calculate the median of each window of {@code k} elements, from left to right.<br/>
 * The median is the middle element when the elements are sorted. If the number of elements is even, there are two possible medians
 * and we assume that the median is the smaller of them.<br/><br/>
 *
 * <i><b>Input</b></i>:<br/>
 ...
 *
 * <i><b>Output</b></i>:<br/>
 * Print {@code n-k+1} values: the medians.<br/>
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final Integer[] result = algorithm.execute();

        final String outputResult = createOutputResult(result);
        System.out.println(outputResult);
    }

    private static String createOutputResult(final Integer[] values) {
    ...
    static class SlidingWindowMedian {
        ...
        Integer[] execute() {
            ...
            final Integer[] result = new Integer[this.n - this.k + 1];

            if (this.k == 1) {
                for (int i = 0; i < this.n; i++) {
                    result[i] = this.sequence[i].value;
                }
            ...
            for (int i = this.k; i < this.n; i++) {
                ...
                result[i - this.k + 1] = part1.last().value;
            }
